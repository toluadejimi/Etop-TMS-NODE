            ...
            pool.query(qry, [token, username], (err, result) => { 
                ...
                else
                {
                    ...
                    }else
                    {
                        ...
                        return res.status(200).render("transactiontypes/transactiontypes", {details: JSON.stringify(response), role: role, usertype, usertype});
                    }
                }
            });
        }catch(e)
            ...
            pool.query(qry, [token, username], (err, result) => { 
                ...
                else
                {
                    ...
                    }else
                    {
                        ...
                        var qry2 = "SELECT * FROM transactiontype";
        ...
        pool.query(qry, [req.cookies.token_tcm, req.cookies.username], (err, result) => {
            ...
            }else
            {
                ...
                }else
                {
                    ...
                    {
                        var qry2 = "DELETE FROM transactiontype where id = $1";
            ...
            }else
            {
                ...
                }else
                {
                    ...
                    }else
                    {
                        ...
                        {
                            var qry2 =
                                "UPDATE transactiontype SET name = $1, commonname = $2, transtype = $3, uses = $4, " + 
                                "position = $5, discountpercent = $6, commissionpercent = $7, discount = $8, commission = $9, baseamtpercentage = $10, baseamtfixed = $11, remarks = $12," + 
                                "datemodified = $13, namemodified = $14 WHERE id = $15";
                            pool.query(qry2, [req.body.name, req.body.commonnanme, req.body.transtype,
                                req.body.uses, req.body.position, req.body.discountpercent,
                                req.body.commissionpercent, req.body.discount, req.body.commission,
                                req.body.baseamtcommission, req.body.baseamtfixed, req.body.remarks,
                                datetime(), result.rows[0].fullname, req.body.id], (err, resul) => {
                                if (err) 
                                {
                                    console.log(err)
                                    logger.info("Database Issue. User: " + req.cookies.username + ". Ip: " + req.clientIp + ". Time: " +  new Date().toLocaleString());
                                    res.status(500).send({"status": 500, "message": "Cannot Update Transaction Types Details. Retry Later or Contact Admin."});
                                }else
                                {
                        ...
                        {
                            var qry2 = "INSERT INTO transactiontype " + 
                                "(name, commonname, transtype, uses, " + 
                                "position, discountpercent, commissionpercent, discount, commission, baseamtpercentage, baseamtfixed, remarks," + 
                            ...
                            pool.query(qry2, [req.body.name, req.body.commonnanme, req.body.transtype,
                                ...
                                {
                                    logger.info("Database Issue. User: " + req.cookies.username + ". Ip: " + req.clientIp + ". Time: " +  new Date().toLocaleString());
                                    res.status(500).send({"status": 500, "message": "Cannot Insert Transaction Types Details. Retry Later or Contact Admin."});
                                }else
                                {
