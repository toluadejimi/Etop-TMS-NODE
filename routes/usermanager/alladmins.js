            ...
            pool.query(qry, [token, username], (err, result) => { 
                ...
                else
                {
                    ...
                    }else
                    {
                        ...
                        return res.status(200).render("user/alladmins", {details: JSON.stringify(response), role: role, usertype, usertype});
                    }
                }
            });
        }catch(e)
...
router.get("/getalladmins", function(req, res)
{
    try
    {
        var str = new Date().toLocaleString();
            ...
            pool.query(qry, [token, username], (err, result) => { 
                ...
                else
                {
                    ...
                    }else
                    {
                        ...
                        var qry2 = "SELECT * FROM etop_users where role = $1";
                        pool.query(qry2, ["admin"], (err, resul) => {
                            if (err) 
                            {
...
router.put("/deleteadmin", function(req, res)
{
    try
    {
        var qry = "SELECT * FROM tokens WHERE token = $1 AND username = $2";
