            ...
            pool.query(qry, [token, username], (err, result) => { 
                ...
                else
                {
                    ...
                    }else
                    {
                        ...
                        return res.status(200).render("settlement/settledagency", {details: JSON.stringify(response), role: role, usertype, usertype});
                    }
                }
            });
        }catch(e)
    ...
    try
    {
        ...
        pool.query(qry, [token, username], (err, result) => { 
            ...
            else
            {
                ...
                {
                    var txn = "SELECT * FROM agentsettlement WHERE tousedate = $1 ORDER BY id ASC";
        ...
        pool.query(qry, [token, username], (err, result) => { 
            ...
            else
            {
                ...
                }else
                {
                    ...
                    var sd = req.body.sd;
                    var ed = req.body.ed;
                    var txn = "SELECT * FROM agentsettlement WHERE tousedate BETWEEN $1 AND $2";
    ...
    try
    {
        ...
        pool.query(qry, [token, username], (err, result) => { 
            ...
            else
            {
                ...
                {
                    var txn = "SELECT * FROM agentsettlement WHERE id = $1";
