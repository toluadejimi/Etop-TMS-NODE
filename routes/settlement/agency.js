            ...
            pool.query(qry, [token, username], (err, result) => { 
                ...
                else
                {
                    ...
                    }else
                    {
                        ...
                        return res.status(200).render("settlement/agency", {details: JSON.stringify(response), role: role, usertype, usertype});
                    }
                }
            });
        }catch(e)
...
router.get("/getallagency", function(req, res)
{
    ...
    try
    {
        ...
        pool.query(qry, [token, username], (err, result) => { 
            ...
            else
            {
                ...
                {
                    var txn = "SELECT * FROM frometranzact WHERE tousedate = $1 ORDER BY id ASC";
        ...
        pool.query(qry, [token, username], (err, result) => { 
            ...
            else
            {
                ...
                }else
                {
                    ...
                    var txn = "SELECT * FROM frometranzact WHERE id > $1 ORDER BY id ASC";
        ...
        pool.query(qry, [token, username], (err, result) => { 
            ...
            else
            {
                ...
                }else
                {
                    ...
                    //console.log(sd);
                    //console.log(ed);
                    var txn = "SELECT * FROM frometranzact WHERE tousedate BETWEEN $1 AND $2";
    ...
    try
    {
        ...
        pool.query(qry, [token, username], (err, result) => { 
            ...
            else
            {
                ...
                {
                    var txn = "SELECT * FROM frometranzact WHERE id = $1";
