            ...
            pool.query(qry, [token, username], (err, result) => { 
                ...
                else
                {
                    ...
                    }else
                    {
                        ...
                        return res.status(200).render("settlement/instantvalue", {details: JSON.stringify(response), role: role, usertype, usertype});
                    }
                }
            });
        }catch(e)
    ...
    try
    {
        ...
        pool.query(qry, [token, username], (err, result) => { 
            ...
            else
            {
                ...
                {
                    var txn = "SELECT * FROM instantvalue WHERE tousedate = $1 OR status = $2 ORDER BY id ASC";
        ...
        pool.query(qry, [token, username], (err, result) => { 
            ...
            else
            {
                ...
                }else
                {
                    ...
                    var txn = "SELECT * FROM instantvalue WHERE id > $1 ORDER BY id ASC";
        ...
        pool.query(qry, [token, username], (err, result) => { 
            ...
            else
            {
                ...
                }else
                {
                    ...
                    var sd = req.body.sd;
                    var ed = req.body.ed;
                    var txn = "SELECT * FROM instantvalue WHERE tousedate BETWEEN $1 AND $2";
    ...
    try
    {
        ...
        pool.query(qry, [token, username], (err, result) => { 
            ...
            else
            {
                ...
                {
                    var txn = "SELECT * FROM instantvalue WHERE id = $1";
        ...
        pool.query(qry, [token, username], (err, result) => { 
            ...
            else
            {
                ...
                }else
                {
                    ...
                    var qry2 =
                        "UPDATE instantvalue SET makername = $1, makerapprovaltime = $2 WHERE id = $3";
                    pool.query(qry2, [name, datetime(), id], (err, resul) => {
                        ...
                        {
                            var qry = "SELECT * FROM instantvalue WHERE id = $1";
                            pool.query(qry, [id], (err, transact) => { 
                                ...
                                else
                                {
                                    ...
                                    if(transaction.checkername !== null)
                                    {
                                        ...
                                        var qry2 =
                                            "UPDATE instantvalue SET status = $1, lastretry = $2 WHERE id = $3";
                                        pool.query(qry2, ["QUEUED", datetime(), id], (err, resul) => {
                                            ...
                                            {
                                                var qry = "SELECT * FROM instantvaluepayment WHERE tid = $1";
                                                pool.query(qry, [transaction.tid], (err, ivp) => { 
                                                    if (err) 
                                                    {
                                                        logger.info("Database connection error: " + err + ". Username: " + username + ". Ip: " + req.clientIp + ". Time: " +  new Date().toLocaleString());
                                                        return res.status(500).send({"status": 500, "message": "Cannot Update. Retry Later."});
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        {
                                                            var qry2 = "INSERT INTO instantvaluepayment " + 
                                                                "(tid, amount, accountname, accountbankcode, accountnumber, bankname, status, nextqueue) " + 
                                                        ...
                                                        }else
                                                        {
                                                            ...
                                                            if(invp.status === "QUEUED")
                                                                ...
                                                                amt = amount;
                                                            var qry2 =
                                                                "UPDATE instantvaluepayment SET amount = $1, accountname = $2, accountbankcode = $3, " + 
                                                                "accountnumber = $4, bankname = $5, status = $6, nextqueue = $7 WHERE tid = $8";
                                                            pool.query(qry2, [amt, transaction.accountname,
                                                                transaction.accountbankcode, transaction.accountnumber, transaction.bankname, 
                                                                "QUEUED", checkTime, transaction.tid], (err, resul) => {
                                                                if (err) 
                                                                {
                                                                    logger.info("Database Issue. User: " + req.cookies.username + ". Ip: " + req.clientIp + ". Time: " +  new Date().toLocaleString());
                                                                    return res.status(500).send({"status": 500, "message": "Cannot Update. Retry Later."});
        ...
        pool.query(qry, [token, username], (err, result) => { 
            ...
            else
            {
                ...
                }else
                {
                    ...
                    var qry2 =
                        "UPDATE instantvalue SET checkername = $1, checkerapprovaltime = $2 WHERE id = $3";
                    pool.query(qry2, [name, datetime(), id], (err, resul) => {
                        if (err) 
                        {
                            console.log(err)
