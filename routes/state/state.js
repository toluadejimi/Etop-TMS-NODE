...
router.get("/getallstatus/:startdate/:enddate", function(req, res)
{
    ...
    try
    {
        ...
        pool.query(qry, [token, username], (err, result) => { 
            ...
            else
            {
                ...
                {
                    const txn = "SELECT * FROM terminal_state WHERE current_date_uzoezi BETWEEN $1 AND $2 order by id asc";
