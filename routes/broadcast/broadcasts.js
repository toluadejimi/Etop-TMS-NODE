            ...
            pool.query(qry, [token, username], (err, result) => { 
                ...
                else
                {
                    ...
                    }else
                    {
                        ...
                        return res.status(200).render("broadcast/broadcast", {details: JSON.stringify(response), role: role, usertype, usertype});
                    }
                }
            });
        }catch(e)
            ...
            pool.query(qry, [token, username], (err, result) => { 
                ...
                else
                {
                    ...
                    }else
                    {
                        ...
                        var qry2 = "SELECT * FROM callhomeroutes";
        ...
        pool.query(qry, [req.cookies.token_tcm, req.cookies.username], (err, result) => {
            ...
            }else
            {
                ...
                }else
                {
                    ...
                    {
                        var qry2 = "DELETE FROM callhomeroutes where id = $1";
            ...
            }else
            {
                ...
                }else
                {
                    ...
                    }else
                    {
                        ...
                        {
                            var qry2 =
                                "UPDATE callhomeroutes SET destinationip = $1, destinationport = $2, url = $3, protocol = $4, " + 
                                "merchantname = $5, merchantid = $6, bankid = $7, bankname = $8, bankcode = $9, remarks = $10," + 
                                "datemodified = $11, namemodified = $12 WHERE id = $13";
                            pool.query(qry2, [req.body.destinationip, req.body.destinationport, req.body.url,
                                req.body.protocol, req.body.merchantname, req.body.merchantid, req.body.bankid,
                                req.body.bankname, req.body.bankcode, req.body.remarks,
                                datetime(), result.rows[0].fullname, req.body.id], (err, resul) => {
                                if (err) 
                                {
                                    console.log(err)
                                    logger.info("Database Issue. User: " + req.cookies.username + ". Ip: " + req.clientIp + ". Time: " +  new Date().toLocaleString());
                                    res.status(500).send({"status": 500, "message": "Cannot Update Broadcast Details. Retry Later or Contact Admin."});
                                }else
                                {
                        ...
                        {
                            var qry2 = "INSERT INTO callhomeroutes " + 
                                "(destinationip, destinationport, url, protocol, " + 
                                "merchantname, merchantid, bankid, bankname, bankcode, remarks," +
                            ...
                            pool.query(qry2, [req.body.destinationip, req.body.destinationport, req.body.url,
                                ...
                                {
                                    logger.info("Database Issue. User: " + req.cookies.username + ". Ip: " + req.clientIp + ". Time: " +  new Date().toLocaleString());
                                    res.status(500).send({"status": 500, "message": "Cannot Insert Broadcast Details. Retry Later or Contact Admin."});
                                }else
                                {
