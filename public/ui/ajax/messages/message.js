...
$( "#btnAppr" ).click(function() {
    ...
    fd.append('walletids', $("#walletids").val());
    if(id)
    {
        fd.append('edit', true);
        fd.append('id', id);
...
$( "#btnDcl" ).click(function() {
    swal({
        title: "Delete?",
        text: "Are you sure you want to delete " + fldata.message + "?",
        type: 'warning',
        ...
        if (result.value) {
            ...
            $.ajax({
                type: "DELETE",
                url : "/tms/messages/delete/" + fldata.id,
                data : fd,
                processData: false,
                contentType: false,
