...
{
    $.ajax({
        url: "/tms/settledinstant/transactiondetails/" + id,
        async: true,
        dataType: 'json',
    ...
    swal({
        ...
        if (result.value) {
            ...
            }else
            {
                ...
                $.ajax({
                    type: "POST",
                    url : "/tms/settledinstant/getbydaterange",
                    data : fd,
                    processData: false,
                    contentType: false,
...
function getAllAgency()
{
    $.ajax({
        type: "GET",
        url : "/tms/settledinstant/getallsettlement",
        processData: false,
        contentType: false,
...
function getAllTerminals()
{
    $.ajax({
        type: "GET",
        url : "/tms/settledinstant/getalltids",
        processData: false,
        contentType: false,
